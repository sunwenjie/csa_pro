...
public class MapCompareUtil {
  ...
  private static PropertiesLoader message_zh_properties = new PropertiesLoader("message_zh.properties");

  private static PropertiesLoader message_en_properties = new PropertiesLoader("message_en.properties");
  ...
  public String compareToDifferent(Map beforeMap, Map afterMap, String compareKeys, String language) {
    ...
    for (String key : compareInfo.keySet()) {
      ...
      if (v1 == null && v2 != null) {
        ...
        rs.append(label + " : " + filterEmpty(transformToStr(v2, key), language) + " → " + filterEmpty(transformToStr(v1, key), language) + "; ");
      }
    }
