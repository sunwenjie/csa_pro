	...
	<div style="padding: 10px;">
		...
		color: #333;pointer-events: auto;padding: 0;" border="1" >
			<tr style="font-size: 20px;">
				<td colspan=17 style="padding: 10px;">客户入账通知-----财务确认端口加款用${isTest}</td>
			</tr>
			...
			<tr style="word-break: keep-all;white-space:nowrap;">
				...
				<td style="padding: 8px;" colspan=12>${finAuditBy}</td>
			</tr>
			<tr style="word-break: keep-all;white-space:nowrap;">
		...
		color: #333;pointer-events: auto;padding: 0;" border="1" >
            <#if blockTrade??>
                <tr style="word-break: keep-all;white-space:nowrap; color: #666; ">
                    <td style="padding: 8px; text-align: right;" colspan=4>客户日均消费额*30天(加款金额RMB 100K 到 RMB 1M)</td>
                    <td style="padding: 8px; text-align: right;" colspan=3>客户日均消费额*30天(加款金额RMB 1M 以上)</td>
                </tr>
                <tr style="word-break: keep-all;white-space:nowrap; color: #666; ">
                    <td style="padding: 8px; text-align: right;" colspan=4>${blockTrade.getAmount30Str()}</td>
                    <td style="padding: 8px; text-align: right;" colspan=3>${blockTrade.getAmount15Str()}</td>
                </tr>
            </#if>
        </table>
