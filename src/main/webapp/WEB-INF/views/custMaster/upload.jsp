			...
			<div class="modal-body">
				...
				<div class="file-box">
			        ...
			        <span class="btn btn-success fileinput-button">
				        ...
				        <input id="fileupload" type="file" name="files" data-url="${ctx}/file/custom/upload">
				    </span>
				    <span class="text-primary"><spring:message code='public.file.valid.customer'/></span>
...
$(function () {
    $('#fileupload').fileupload({
    	add: function(e, data) {
            ...
            var fileType = data.files[0].name.split('.').pop().toLowerCase(), allowdtypes = 'xlsx';
        ...
        dataType: 'json',
        	...
        	if(data.result.success == 'true'){
        		 $("#messange").append('<li><code style="color:#5CB85C">'+data.result.message+'</code></li>');
        		$("#errorMessange").empty();
        	}else{
        		 $("#errorMessange").html('<p style="color: red;">' + data.result.message + '</p>');
        	}
