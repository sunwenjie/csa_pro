        	...
        	if(data.result.success == 'true'){
        		$.each(data.files, function (index, file) {
                  ...
                  //放到form
    				...
    				if(tmpExt == "pdf"){
    					$("#dumpImageDiv").append('<img id="uploadImg'+data.result.fileId+'" src="${ctx}/static/images/pdf.png" style="height:120px;width:95px;margin-right:10px;" />');
    				}else{
    					$("#dumpImageDiv").append('<img id="uploadImg'+data.result.fileId+'" src="${ctx}/file/dumpImage?path='+data.result.filePath+'" style="height:120px;width:100px;margin-right:10px;" />');
    				}
